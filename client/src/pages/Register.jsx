...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <div className="card animate-scale-in" style={{ width: "100%", maxWidth: 420, padding: "40px 36px" }}>
        {/* Logo */}
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 20 }}>
            <div className="logo-mark">CS</div>
            <span className="brand-gradient" style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.03em" }}>
              CodeSync
            </span>
          </div>
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                required
              />
              <button type="button" onClick={() => setShowPass(!showPass)} style={inputStyle}>
                {showPass ? (
